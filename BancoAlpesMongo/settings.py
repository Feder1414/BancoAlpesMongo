"""
Django settings for BancoAlpesMongo project.
...
SECRET_KEY = 'django-insecure-(-c8h26((i6j2$im-w#b5_=^ofkol^$s=8har0)-0gzbyk(fde'
...
ROOT_URLCONF = 'BancoAlpesMongo.urls'
...
WSGI_APPLICATION = 'BancoAlpesMongo.wsgi.application'
...
#connect(host="mongodb://localhost:27017/BancoAlpes")
# Password validation
